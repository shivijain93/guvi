interface CricketConfiguration{
    runs:Number,
    wickets:Number,
    balls:Number,
    player:Number,
...
constructor(cricconfig:CricketConfiguration)
{
    this.runs=0 ;
...
{	
	if(team=='1'){
		...
		this.r="Runs: "+this.runs;
		this.p="Player "+this.player;
		this.w="Wickets: "+this.wickets;
		this.b="Balls left: "+this.balls;
		td2_r1.innerHTML=this.r;
		td3_w1.innerHTML=this.w;
		td_p1.innerHTML=this.p;
		td4_b1.innerHTML=this.b;
		if(this.player==12)
		{
	...
	var run=Math.floor((Math.random()*100)%7);
		...
		this.w="Wickets: "+this.wickets;
		this.b="Balls left: "+this.balls;
		td2_r2.innerHTML=this.r;
		td3_w2.innerHTML=this.w;
		td_p2.innerHTML=this.p;
		td4_b2.innerHTML=this.b;
		if(this.wickets==11||this.balls==0||this.player==12)
		{
